---
title: "HCR E15 FGFR2 ISOFORMS RNA HCR,MCF7, U2OS, U2OS(pBIIIB) Test 15 for paper"
author: "Asaf Shilo"
...
spot_B1Full_violin <- ggplot(dt_Full, aes(x = cell_line, y = spot_n_488, fill = cell_line))


spot_B1Full_violin + geom_violin() + geom_boxplot(outlier.shape = NA, width=0.1, color="black", alpha=0.2)+
            ylim(0,75)+
...
```{r, fig.width=10,fig.height=8}
spot_B1IIIb_violin <- ggplot(dt_IIIB, aes(x = cell_line, y = spot_n_488, fill = cell_line))

spot_B1IIIb_violin + geom_violin() + geom_boxplot(outlier.shape = NA, width=0.1, color="black", alpha=0.2)+
            ylim(0,25)+
...
```{r, fig.width=10,fig.height=8}
spot_B2PGK1_violin <- ggplot(dt_PGK1, aes(x = cell_line, y = spot_n_562, fill = cell_line))

spot_B2PGK1_violin + geom_violin() + geom_boxplot(outlier.shape = NA, width=0.1, color="black", alpha=0.2)+
            ylim(0,250)+
...
Full transcript specific probes
```{r, fig.width=10,fig.height=9}
spot_Full_boxplot <- ggplot(dt_Full, aes(x = cell_line, y = spot_n_488, fill = cell_line))

spot_Full_boxplot + geom_boxplot() +
            ylim(0,55)+
...
D7-10 transcript specific probes
```{r, fig.width=10,fig.height=9}
spot_D7_10_boxplot <- ggplot(dt_D7_10, aes(x = cell_line, y = spot_n_647, fill = cell_line))

spot_D7_10_boxplot + geom_boxplot() +
            ylim(0,55)+
...
```{r, }
spot_FGFR2_scatter <- ggplot(dt_MP_IIIbOE, aes(x = spot_n_488, y = spot_n_647))
...
spot_FGFR2_scatter + geom_point() +
          ...
          stat_cor(label.x=04, label.y=175, size = 5, face = "bold")+
            xlim(0,150)+
            ylim(0,200)+
            labs(y = "FGFR2-D7-10 HCR Spots per Cell ", x = "FGFR2-IIIb HCR Spots per Cell") +
            theme_classic()+
                theme(
