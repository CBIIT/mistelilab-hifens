...
Creating ALL and None probes datasets
```{r, echo = F}
...
spot_Full_box + geom_boxplot(alpha = 0.8,color="black", fill = "red3") + 
...
```{r, fig.width=8,fig.height=8}
Intensity_Full_boxplot <- ggplot(Full_dt, aes(y = Intensity_647 , x= cell_line)) 

Intensity_Full_boxplot + geom_boxplot(alpha = 0.8, color="black", fill = "red3") + 
...
spot_TBP_box + geom_boxplot(alpha = 0.8, color = "black", fill = "#00BFC4") + 
...
```{r, fig.width=8,fig.height=8}
Intensity_TBP_boxplot <- ggplot(All_dt, aes(y = Intensity_562 , x= cell_line)) 

Intensity_TBP_boxplot + geom_boxplot(alpha = 0.8, color = "black", fill = "#00BFC4") + 
...
```{r, fig.width=8,fig.height=8}
spot_IIIb_box <- ggplot(IIIB_dt, aes(y = spot_488_n , x = cell_line)) 

spot_IIIb_box + geom_boxplot(alpha = 0.8, color = "black", fill = "green4") + 
...
```{r, fig.width=8,fig.height=8}
Intensity_Full_boxplot <- ggplot(IIIB_dt, aes(y = Intensity_488 , x= cell_line)) 

Intensity_Full_boxplot + geom_boxplot(alpha = 0.8, color = "black", fill = "green4") + 
...
```{r, fig.width=8,fig.height=8}
spot_IIIc_box <- ggplot(IIIC_dt, aes(y = spot_488_n , x = cell_line)) 

spot_IIIc_box + geom_boxplot(alpha = 0.8, color = "black", fill = "blue3") + 
...
```{r, fig.width=8,fig.height=8}
Intensity_IIIc_boxplot <- ggplot(IIIC_dt, aes(y = Intensity_488 , x= cell_line)) 

Intensity_IIIc_boxplot + geom_boxplot(alpha = 0.8, color = "black", fill = "blue3") + 
