...
IIIb_n<-FGFR2_IIIB_n + geom_point(size = (1))+
...
```{r, echo = F}
ggsave("IIIb_n.pdf", width=11, height = 8)
```
...
Full_n<- FGFR2_Full_n + geom_point(size = (1))+
 scale_color_manual(values=c('#F8766D','#B79F00', '#00BA38', '#00BFC4', '#619CFF', '#F564E3'), name="plate index") +
  xlab("Well index") +
...
```{r, echo = F}
ggsave("Full_n.pdf", width=11, height = 8)
```
...
FGFR_Annot<-FGFR2_Full_IIIB + geom_point(shape = 21, color = "pink", size = 0.2 ) + 
  coord_equal() +
